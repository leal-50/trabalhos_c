...
int main() {
    ...
    char estado1; // Vai armazenar a letra do estado (array de 1 caractere)
    char cod_carta1[4]; // Vai armazenar o código da carta (array de 4 caracteres, incluindo o terminador nulo)
    ...
    char estado2; // Vai armazenar a letra do estado (array de 1 caractere)
    char cod_carta2[4]; // Vai armazenar o código da carta (array de 4 caracteres, incluindo o terminador nulo)
